...
if(isset($_POST) && count($_POST) > 0) {
    ...
    $c->setPhoneNumber($_POST['inputPhoneNumber']);
    $c->setDate($_POST['inputDate']);
    $c->setTextComents($_POST['textComents']);
...
<body>
  ...
  <div class="backgroundAboutUs">
    ...
    <div class="containerAboutUsContent">
      ...
      <article clasName="boxTextAboutUs">
        <h2>Sobre nós</h2>
        <p>Nossa culinária é extremamente versátil, direcionada para atender toda a multiplicidade de gostos ao redor do pais e do mundo. Nos de uma chance, e mostraremos do que nosso restaurante é capaz de saciar qualuer paladar de Patrocínio! <br><br><br>Estamos esperando por você todos os dias de 9:00 às 20:00.
        </p>
        <br>
 ...
 <div class="containerDifferential">
    <section class="titlesDifferential">
      ...
      <aside><i>Com base nos nossos mais de um milhão de clientes satisfeitos</i>
      </aside>
    </section>
    <br>
    <section class="containerBoxContentDifferential">
      ...
      <article class="boxContentDifferential">
        ...
        <h4>Preço justo</h4>
        <p>A nossa comida com certeza vale seu custo. Por menos de 30,00 R$ você consegue uma refeição de qualidade e satisfatória
        </p>
      </article>
      <article class="boxContentDifferential">
  ...
  <img src="./img/details/foodBack1.jpg" alt="jdjdjh">
    ...
    <article class="boxDishesContent">
      ...
      <div class="dishesContent brasileiro">
        ...
        <div>
          <article>
            ...
            <p>Feita com feijão preto e carne de porco em mil e uma formas, a feijoada é um prato que representa bem a cultura brasileira, além de ser uma refeição para lá de farta e repleta de acompanhamentos como arroz, farofa, couve e laranja. outras versões deliciosas.
            </p>
          </article>
      ...
      <div class="dishesContent brasileiro">
        ...
        <div>
          <article>
            ...
            <p>Composto por camarões refogados junto com leite de coco, azeite de dendê e temperos verdes, o bobó de camarão é um prato típico afro-brasileiro, que conquista diversos paladares de todos os cantos do País e do mundo.
      ...
      <div class="dishesContent brasileiro">
        ...
        <div>
          <article>
            ...
            <p>O acarajé é uma deliciosa iguaria preparada com um bolinho de feijão-fradinho artesanal, temperado com cebola e sal, frito em azeite de dendê e depois recheado com vatapá (leite de coco, castanha de caju, amendoim e camarão), vinagrete e camarão seco.
            </p>
          </article>
      ...
      <div class="dishesContent portugues">
        ...
        <div>
          <article>
            <h3><i>Churros Recheada</i></h3>
              <article>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>           </article>
            <p>Deliciosos, açucarados, crocantes por fora e super recheados por dentro, 9s Churross são tradicionais na Euroupa. Eles são normalmente consumidos no café da manhã mergulhados em chá, chocolate quente, doce de leite ou café com leite. 
            </p>
          </article>
      ...
      <div class="dishesContent portugues">
        ...
        <div>
          <article>
            ...
            sendo normalmente feito com vegetais cozidos e carnes.As receitas também podem levar feijão, cenoura, batata, arroz, nabo, frango, orelha e pé de porco, além de carne bovina.
            </p>
          </article>
        ...
        <div>
          <article>
            <h3><i>Arroz de Polvo</i></h3>
              <article>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>               <span>&#9733;</span>           </article>
            <p>O arroz de polvo é bastante conhecido em terras lusitanas e é feito com um arroz de grão mais longo. Ele é cozido no mesmo caldo que o polvo é preparado, o que enfatiza ainda mais o seu sabor. A receita também inclui tomate, vinho branco, azeite e diversos tipos de temperos
            </p>
          </article>
...
<div class="containerDiscover">
  ...
  <article>
    <h4>Descubra</h4>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic adipisci quae mollitia ipsum quod eius, non porro saepe a, eaque corporis quidem quos enim qui atque quaerat alias praesentium ullam.
    </p>
  </article>
</div>
...
<div class="containerAvaliations">
  ...
  <div class="contentAvaliations">
    <article class="boxContentAvaliations hideImage">
      ...
      <aside> <span>João Paulo</span> <article>
        <span>&#9733;</span>
        <span>&#9733;</span>
        <span>&#9733;</span>
        <span>&#9733;</span>
      ...
      <p class="textAvaliations">
       Adorei a comida, principalmente os churros, tava realmente bem recheado.
    </p>
    </article>
    <article class="boxContentAvaliations hideImage">
      <img src="img/details/meat3.png" alt="starsFundo">
     
      <aside> <span>José Arantes</span> <article>
        <span>&#9733;</span>
        <span>&#9733;</span>
        <span>&#9733;</span>
        <span>&#9733;</span>
  ...
  <form action="">
    <svg onclick="closeModal()" id="closeBtn" xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="#FFD700" class="bi bi-x-lg" viewBox="0 0 16 16"> <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/> </svg>
    ...
    <button id="btnAvaliation" disabled type="submit">Enviar avaliação</button>
      ...
      <div>
      <svg onclick="openModal()" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16"> <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
      </svg>
      </div>
    </article>
  </div>
...
<div class="containerContact">
  <form action="">
    ...
    <article class="boxInput">
      ...
      <input required type="number" name="inputPhoneNumber" id="inputPhoneNumber" placeholder="00 9 0000-0000" />
    </article>
    ...
    <article class="boxInput">
      ...
      <br>
      <textarea required name="textComents" id="textComents" rows="4" cols="20" placeholder="2 feijodadas e 1 caldo verde..."></textarea>
    </article>
